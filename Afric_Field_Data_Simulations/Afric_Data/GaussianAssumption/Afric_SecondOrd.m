...
%% Plotting Results
figure(1); imagesc(angle(ground_2)); title('2nd Order Ground Interferometric Phase');colorbar;
figure(2); imagesc(angle(vegetation_2)); title('2nd Order Vegetation Interferometric Phase');colorbar;
figure(3); imagesc(angle(vegetation_2) - angle(ground_2)); title('4th Order V-G');colorbar;
figure(4); imagesc(abs(ground_2)); title('2nd Order Ground Magnitude');colorbar;
figure(5); imagesc(abs(vegetation_2)); title('2nd Order Vegetation Magnitude');colorbar;