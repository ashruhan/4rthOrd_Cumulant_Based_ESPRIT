...
ground_angle_rmse_4 = zeros(DistLength ,DistLength );
ground_angle_rmse_2 = zeros(DistLength ,DistLength );

vegitation_angle_rmse_4 = zeros(DistLength ,DistLength );
vegitation_angle_rmse_2 = zeros(DistLength ,DistLength );
...
%% Plotting Results
figure(1);
meshc((ground_angle_rmse_4));title('4th order ground RMS Error');
xlabel('vegetation sweep 1-89 degrees');ylabel('ground sweep 1-89 degrees');
figure(2);
meshc((vegitation_angle_rmse_4));title('4th order vegetation RMS Error');
xlabel('vegetation sweep 1-89 degrees');ylabel('ground sweep 1-89 degrees');
figure(3)
meshc((ground_angle_rmse_2));title('2nd order ground RMS Error');
xlabel('vegetation sweep 1-89 degrees');ylabel('ground sweep 1-89 degrees');
figure(4)
meshc((vegitation_angle_rmse_2));title('2nd order vegetation RMS Error');
xlabel('vegetation sweep 1-89 degrees');ylabel('ground sweep 1-89 degrees');
figure(5)
