...
%         eye_4 = (6*min(diag(abs(eigenvalCov11_4))))/(sum(diag(abs(eigenvalCov11_4)))-min(diag(abs(eigenvalCov11_4))))
...
figure(7)
title('4rth Order ESPRIT RMS Error Vs. Magnitude');
...
figure(8)
title('2nd Order ESPRIT RMS Error Vs. Magnitude');
ylabel('RMS Error (degrees)');xlabel('Magnitude');
hold on;
