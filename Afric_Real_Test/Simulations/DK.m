...
figure(1);
title('ESPIRIT CUMULANT Interferometric Phases');
...
axis([-10 20 -60 -10]);
legend('CUMULANT Ground','ESPIRIT Ground','CUMULANT Vegitation','ESPIRIT Vegitaion','Location','northeast')
hold off

figure(2)
title('ESPIRIT CUMULANT Coherance');
...
legend('CUMULANT Ground Coherance','ESPIRIT Ground Coherancee','CUMULANT Vegitation Coherance','ESPIRIT Vegitation Coherancee','Location','southeast');
hold off;
