...
Pol_Cum_signal_one = [1;1;1;1;1;1]/3; %vegitation
...
for Averaged_sample = 1:Averaged_samples;
    ...
    for n = 1:samples
        ...
        sort_pol = abs(Pol_Cum_signal_one'*u);
        [~,kk] = sort(sort_pol,'descend');
        signal_one_phase_est(Averaged_sample) = signal_one_phase_est(Averaged_sample) + 0.5*angle(c(kk(1),kk(1)))/samples;
