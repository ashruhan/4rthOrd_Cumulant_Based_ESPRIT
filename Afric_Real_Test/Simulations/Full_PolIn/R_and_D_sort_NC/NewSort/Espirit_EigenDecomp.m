...
for Averaged_sample = 1:Noise_samples;
    ...
    for unusedVariable = 1:Averaging_loop_size;
        ...
        est_ground_angle(Averaged_sample) = est_ground_angle(Averaged_sample) + EigenVal(kk(1))/Averaging_loop_size;
        est_noise_angle(Averaged_sample) = est_noise_angle(Averaged_sample) + EigenVal(kk(2))/Averaging_loop_size;
        est_vegitation_angle(Averaged_sample) = est_vegitation_angle(Averaged_sample) + EigenVal(kk(3))/Averaging_loop_size;
    end
end
