...
for Noise = 100:-1:1;
    ...
    RMS_ground = sqrt((1/average)*RMS_ground);%%FINAL AVERAGING
    RMS_veg = sqrt((1/average)*RMS_veg);      %%FINAL AVERAGING
    ...
    RMS_ground = 0; %%USED FOR AVERAGING OVER DIFFERENT POINTS OF NOISE
    RMS_veg = 0;    %%USED FOR AVERAGING OVER DIFFERENT POINTS OF NOISE
end
figure
hold on
