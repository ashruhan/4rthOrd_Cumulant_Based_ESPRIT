...
water = zeros(ylength-r,xlength-c);
...
for row = r+1:ylength-r;
    for col = c+1:xlength-c;
        ...
        S1_4 = [sh1.*sh1;sv1.*sv1;sx1.*sx1;sh1.*sv1;sh1.*sx1;sv1.*sx1;];
        S2_4 = [sh2.*sh2;sv2.*sv2;sx2.*sx2;sh2.*sv2;sh2.*sx2;sv2.*sx2;];
        ...
        for i = 1:forth_order
            ...
            if abs(eigenval_4(i,i))^2....
                    *abs(eigenvec_4(3,i))^2....
                    >....
                    10*(abs(eigenval_4(i,i))^2....
                    *(abs(eigenvec_4(1,i))^2....
                    + abs(eigenvec_4(2,i))^2));
                
                water(row,col) = eigenval_4(i,i);
                water_detect = 1;
                break;
...
figure(5); imagesc(0.5*angle(water));
figure(6); imagesc(abs(water));