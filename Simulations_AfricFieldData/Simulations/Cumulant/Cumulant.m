function [ Cumulant_11,Cumulant_12,Cumulant_22 ] = Cumulant( s1_Noise,s2_Noise ,Window_optimal)
 ...
 %% Forming Cumulant two two Matrix
        %% HH
        Cumulant_22(1,1) = R22_4(1,1) - E_h2_h2*conj(E_h2_h2)...
            - E_h2_h2c*E_h2_h2c ...
            - E_h2_h2c*E_h2_h2c;
        
        Cumulant_22(1,2) = R22_4(1,2) - E_h2_h2*conj(E_v2_v2)...
            - E_h2_v2c*E_h2_v2c...
            - E_h2_v2c*E_h2_v2c;
        
        Cumulant_22(1,3) = R22_4(1,3) - E_h2_h2*conj(E_x2_x2)...
            - E_h2_x2c*E_h2_x2c...
            - E_h2_x2c*E_h2_x2c;
        
        Cumulant_22(1,4) = R22_4(1,4) - E_h2_h2*conj(E_h2_v2)...
            - E_h2_h2c*E_h2_v2c...
            - E_h2_v2c*E_h2_h2c;
        
        Cumulant_22(1,5) = R22_4(1,5) - E_h2_h2*conj(E_h2_x2)...
            - E_h2_h2c*E_h2_x2c...
            - E_h2_x2c*E_h2_h2c;
        
        Cumulant_22(1,6) = R22_4(1,6) - E_h2_h2*conj(E_v2_x2)...
            - E_h2_v2c*E_h2_x2c...
            - E_h2_x2c*E_h2_v2c;
        %% VV
        Cumulant_22(2,1) = R22_4(2,1) - E_v2_v2*conj(E_h2_h2)...
            - E_v2_h2c*E_v2_h2c...
            - E_v2_h2c*E_v2_h2c;
        
        Cumulant_22(2,2) = R22_4(2,2) - E_v2_v2*conj(E_v2_v2)...
            - E_v2_v2c*E_v2_v2c...
            - E_v2_v2c*E_v2_v2c;
        
        Cumulant_22(2,3) = R22_4(2,3) - E_v2_v2*conj(E_x2_x2)...
            - E_v2_x2c*E_v2_x2c...
            - E_v2_x2c*E_v2_x2c;
        
        Cumulant_22(2,4) = R22_4(2,4) - E_v2_v2*conj(E_h2_v2)...
            - E_v2_h2c*E_v2_v2c...
            - E_v2_v2c*E_v2_h2c;
        
        Cumulant_22(2,5) = R22_4(2,5) - E_v2_v2*conj(E_h2_x2)...
            - E_v2_h2c*E_v2_x2c...
            - E_v2_x2c*E_v2_h2c;
        
        Cumulant_22(2,6) = R22_4(2,6) - E_v2_v2*conj(E_v2_x2)...
            - E_v2_v2c*E_v2_x2c...
            - E_v2_x2c*E_v2_v2c;
        %% XX
        
        Cumulant_22(3,1) = R22_4(3,1) - E_x2_x2*conj(E_h2_h2)...
            - E_x2_h2c*E_x2_h2c...
            - E_x2_h2c*E_x2_h2c;
        
        Cumulant_22(3,2) = R22_4(3,2) - E_x2_x2*conj(E_v2_v2)...
            - E_x2_v2c*E_x2_v2c...
            - E_x2_v2c*E_x2_v2c;
        
        Cumulant_22(3,3) = R22_4(3,3) - E_x2_x2*conj(E_x2_x2)...
            - E_x2_x2c*E_x2_x2c...
            - E_x2_x2c*E_x2_x2c;
        
        Cumulant_22(3,4) = R22_4(3,4) - E_x2_x2*conj(E_h2_v2)...
            - E_x2_h2c*E_x2_v2c...
            - E_x2_v2c*E_x2_h2c;
        
        Cumulant_22(3,5) = R22_4(3,5) - E_x2_x2*conj(E_h2_x2)...
            - E_x2_h2c*E_x2_x2c...
            - E_x2_x2c*E_x2_h2c;
        
        Cumulant_22(3,6) = R22_4(3,6) - E_x2_x2*conj(E_v2_x2)...
            - E_x2_v2c*E_x2_x2c...
            - E_x2_x2c*E_x2_v2c;
        %% HV
        Cumulant_22(4,1) = R22_4(4,1) - E_h2_v2*conj(E_h2_h2)...
            - E_h2_h2c*E_v2_h2c...
            - E_h2_h2c*E_v2_h2c;
        
        Cumulant_22(4,2) = R22_4(4,2) - E_h2_v2*conj(E_v2_v2)...
            - E_h2_v2c*E_v2_v2c...
            - E_h2_v2c*E_v2_v2c;
        
        Cumulant_22(4,3) = R22_4(4,3) - E_h2_v2*conj(E_x2_x2)...
            - E_h2_x2c*E_v2_x2c...
            - E_h2_x2c*E_v2_x2c;
        
        Cumulant_22(4,4) = R22_4(4,4) - E_h2_v2*conj(E_h2_v2)...
            - E_h2_h2c*E_v2_v2c...
            - E_h2_v2c*E_v2_h2c;
        
        Cumulant_22(4,5) = R22_4(4,5) - E_h2_v2*conj(E_h2_x2)...
            - E_h2_h2c*E_v2_x2c...
            - E_h2_x2c*E_v2_h2c;
        
        Cumulant_22(4,6) = R22_4(4,6) - E_h2_v2*conj(E_v2_x2)...
            - E_h2_v2c*E_v2_x2c...
            - E_h2_x2c*E_v2_v2c;
        %% HX
        Cumulant_22(5,1) = R22_4(5,1) - E_h2_x2*conj(E_h2_h2)...
            - E_h2_h2c*E_x2_h2c...
            - E_h2_h2c*E_x2_h2c;
        
        Cumulant_22(5,2) = R22_4(5,2) - E_h2_x2*conj(E_v2_v2)...
            - E_h2_v2c*E_x2_v2c...
            - E_h2_v2c*E_x2_v2c;
        
        Cumulant_22(5,3) = R22_4(5,3) - E_h2_x2*conj(E_x2_x2)...
            - E_h2_x2c*E_x2_x2c...
            - E_h2_x2c*E_x2_x2c;
        
        Cumulant_22(5,4) = R22_4(5,4) - E_h2_x2*conj(E_h2_v2)...
            - E_h2_h2c*E_x2_v2c...
            - E_h2_v2c*E_x2_h2c;
        
        Cumulant_22(5,5) = R22_4(5,5) - E_h2_x2*conj(E_h2_x2)...
            - E_h2_h2c*E_x2_x2c...
            - E_h2_x2c*E_x2_h2c;
        
        Cumulant_22(5,6) = R22_4(5,6) - E_h2_x2*conj(E_v2_x2)...
            - E_h2_v2c*E_x2_x2c...
            - E_h2_x2c*E_x2_v2c;
        %%VX
        Cumulant_22(6,1) = R22_4(6,1) - E_v2_x2*conj(E_h2_h2)...
            - E_v2_h2c*E_x2_h2c...
            - E_v2_h2c*E_x2_h2c;
        
        Cumulant_22(6,2) = R22_4(6,2) - E_v2_x2*conj(E_v2_v2)...
            - E_v2_v2c*E_x2_v2c...
            - E_v2_v2c*E_x2_v2c;
        
        Cumulant_22(6,3) = R22_4(6,3) - E_v2_x2*conj(E_x2_x2)...
            - E_v2_x2c*E_x2_x2c...
            - E_v2_x2c*E_x2_x2c;
        
        Cumulant_22(6,4) = R22_4(6,4) - E_v2_x2*conj(E_h2_v2)...
            - E_v2_h2c*E_x2_v2c...
            - E_v2_v2c*E_x2_h2c;
        
        Cumulant_22(6,5) = R22_4(6,5) - E_v2_x2*conj(E_h2_x2)...
            - E_v2_h2c*E_x2_x2c...
            - E_v2_x2c*E_x2_h2c;
        
        Cumulant_22(6,6) = R22_4(6,6) - E_v2_x2*conj(E_v2_x2)...
            - E_v2_v2c*E_x2_x2c...
            - E_v2_x2c*E_x2_v2c;
